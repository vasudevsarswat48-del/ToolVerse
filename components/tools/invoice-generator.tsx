...
>
  ...
  className="bg-white text-black font-sans text-xs border-2 border-black w-[210mm] max-w-full h-[285mm] p-5 mx-auto flex flex-col justify-between box-border overflow-hidden"
>
        <div>
          {/* Header Banner */}
